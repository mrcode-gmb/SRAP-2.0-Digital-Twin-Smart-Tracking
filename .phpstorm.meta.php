...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/kpi nitda project/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/kpi nitda project/public/storage',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','inertia.ssr.enabled','inertia.ssr.url','inertia.ssr.ensure_bundle_exists',
...
'sanctum.csrf-cookie','dashboard','admin.users',
'admin.settings','researcher.upload','researcher.reports','analyst.analytics','analyst.kpi',
'profile.edit','profile.update','profile.destroy','kpis.index','kpis.create',
'kpis.store','kpis.show','kpis.edit','kpis.update','kpis.destroy',
'milestones.index','milestones.create','milestones.store','milestones.show','milestones.edit',
'milestones.update','milestones.destroy','srap-pillars.index','srap-pillars.create','srap-pillars.store',
'srap-pillars.show','srap-pillars.edit','srap-pillars.update','srap-pillars.destroy','ai-predictions.index',
'ai-predictions.manual-predict','ai-predictions.bulk-predict','ai-predictions.download','ai-predictions.kpi-performance','ai-predictions.milestone-completion',
'ai-predictions.risk-assessment','ai-predictions.trend-analysis','ai-predictions.generate-insights','ai-predictions.update-model','scenarios.index',
'scenarios.simulate','scenarios.results','scenarios.compare','scenarios.export','scenarios.destroy',
'admin.alerts.index','admin.alerts.create','admin.alerts.store','admin.alerts.show','admin.alerts.edit',
'admin.alerts.update','admin.alerts.destroy','admin.alerts.acknowledge','admin.alerts.mark-read','admin.alerts.unread-count',
'admin.reports.index','admin.reports.create','admin.reports.store','admin.reports.show','admin.reports.edit',
'admin.reports.update','admin.reports.destroy','admin.reports.download','admin.chatbot.index','admin.chatbot.create',
'admin.chatbot.store','admin.chatbot.show','admin.chatbot.edit','admin.chatbot.update','admin.chatbot.destroy',
'admin.chatbot.message','admin.chatbot.feedback','admin.users.index','admin.users.create','admin.users.store',
'admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy','admin.users.reset-password',
'admin.users.toggle-status','admin.users.bulk-action','admin.progress-upload.index','admin.progress-upload.create','admin.progress-upload.store',
'admin.progress-upload.show','admin.progress-upload.edit','admin.progress-upload.update','admin.progress-upload.destroy','admin.progress-upload.template',
'admin.progress-upload.process','admin.scenarios.index','admin.scenarios.create','admin.scenarios.store','admin.scenarios.show',
'admin.scenarios.edit','admin.scenarios.update','admin.scenarios.destroy','admin.scenarios.simulate','admin.scenarios.show',
'admin.scenarios.compare','admin.scenarios.export','security.overview','security.api','ai.chatbot',
'ai.models','error.403','register','login','password.request','password.email','password.reset','password.store',
