...
export default function KPIIndex({ kpis, pillars, departments, filters }) {
    ...
    const handleDelete = (kpi) => {
        if (confirm(`Are you sure you want to delete "${kpi.name}"?`)) {
            router.delete(route('admin.kpis.destroy', kpi.id));
        }
    };
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 pt-2 border-t">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                Due: {kpi.end_date ? new Date(kpi.end_date).toLocaleDateString() : 'N/A'}
                                            </div>
                                        </div>

                                        {/* Actions */}
                                        <div className="flex items-center space-x-2 pt-2">
                                            <Link href={route('admin.kpis.show', kpi.id)}>
                                                <Button variant="outline" size="sm" className="flex-1">
                                                    <Eye className="w-4 h-4 mr-2" />
                                                    View
                                                </Button>
                                            </Link>
                                            <Link href={route('admin.kpis.edit', kpi.id)}>
                                                <Button variant="outline" size="sm" className="flex-1">
