...
export default function MilestoneCreate({ kpis, users, selectedKpi }) {
            ...
            <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Add a new milestone to track progress on your KPIs
                    </p>
                </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Provide the essential details for your milestone
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Set the timeline and priority level for this milestone
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Provide more context and requirements for this milestone
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div>
