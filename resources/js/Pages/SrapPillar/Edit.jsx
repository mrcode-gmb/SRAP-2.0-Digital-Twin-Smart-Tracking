...
export default function SrapPillarEdit({ pillar }) {
    const { data, setData, put, processing, errors } = useForm({
        name: pillar.name || '',
        code: pillar.code || '',
        description: pillar.description || '',
        objectives: pillar.objectives || '',
        success_metrics: pillar.success_metrics || '',
        target_completion_date: pillar.target_completion_date || '',
        budget_allocation: pillar.budget_allocation || '',
        responsible_department: pillar.responsible_department || '',
        priority_level: pillar.priority_level || 'medium',
        is_active: pillar.is_active ?? true
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/srap-pillars/${pillar.id}`);
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Pillar: ${pillar.name}`} />
            ...
            <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Update the details for this strategic pillar
                    </p>
                </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update the essential details for your SRAP pillar
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update management and timeline details for this pillar
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center justify-end space-x-4">
                            ...
                            <Button type="submit" disabled={processing}>
                                ...
                                {processing ? 'Updating...' : 'Update Pillar'}
                            </Button>
                        </div>
                    </form>
                </motion.div>
